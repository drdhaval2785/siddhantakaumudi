...
def revhistory():
	historydata = [
		...
		('1.2.0','2017-02-12','1. Captured all verbs with meaning and number in XML itself. See https://github.com/drdhaval2785/siddhantakaumudi/issues/6 for details.','Dr. Dhaval Patel','drdhaval2785@gmail.com'),
	]
